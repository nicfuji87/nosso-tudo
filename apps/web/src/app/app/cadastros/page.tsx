...
import { listCartoes, listCategorias, listContas, listEntidades } from "@/lib/db/queries";
...
export default async function CadastrosPage() {
  ...
  const [categorias, entidades, contas, cartoes] = await Promise.all([
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Cadastros"
        description="Categorias, pessoas, contas e cartões da sua casa."
      />
      <CadastrosView
